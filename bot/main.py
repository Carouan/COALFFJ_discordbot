...
def build_html_report(daily_msgs: dict, date_debut: str, date_fin: str) -> str:
    ...
    # 5) Pied de page
    html_chunks.append("""
    <hr style="margin:30px 10px; border:none; border-top:1px solid #CCC;" />
    <p style="text-align:center; font-size:14px; color:#777;">
      ien de désabonnement à la newsletter, logos des différentes associations et coordonnées perso.
    </p>
    """)
